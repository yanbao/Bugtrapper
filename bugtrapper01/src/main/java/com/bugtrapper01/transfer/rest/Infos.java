...
public class Infos {
    ...
    @PostMapping(value = "/getDaily")
    public List getDaily(@RequestParam(value = "token", required = true) String token,
    ...
    @PostMapping(value = "/getDeviate")
    public List getDeviate(@RequestParam(value = "token", required = true) String token,
                           @RequestParam(value = "tid", required = true) String tid
    ...
    public List getDeviate2(@RequestParam(value = "token", required = true) String token,
                            @RequestParam(value = "tid", required = true) String tid
    ...
    public List getRaw(@RequestParam(value = "token", required = true) String token,
                       @RequestParam(value = "tid", required = true) String tid
