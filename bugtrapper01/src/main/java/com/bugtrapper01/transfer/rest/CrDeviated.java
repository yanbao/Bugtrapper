...
public class CrDeviated {
    ...
    @PostMapping(value = "/corHoursInfo")
    public List crDeviate(@RequestParam(value = "token", required = true) String token,
                          ...
                          @RequestParam(value = "auto", required = true) int auto,//是否使用随机数
